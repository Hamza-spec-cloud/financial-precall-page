...
const GALRIV: CaseStudy = {
  ...
  logoSrc: "/vsl/testimonials/galriv-logo.png",
  ...
  duration: "120 Days",
  screenshots: [
    { src: "/vsl/testimonials/galriv-1.png", alt: "Galriv profit and cash collected dashboard", width: 1200, height: 760 },
    { src: "/vsl/testimonials/galriv-2.png", alt: "Galriv all-time products purchased dashboard", width: 1200, height: 700 },
  ],
};

const COMMISSION_CLUB: CaseStudy = {
  logoSrc: "/vsl/testimonials/cc-logo.png",
  ...
  duration: "30 Days",
  screenshots: [
    { src: "/vsl/testimonials/cc-1.jpeg", alt: "Commission Club ad spend, revenue, ROAS and profit", width: 1200, height: 380 },
    { src: "/vsl/testimonials/cc-2.jpeg", alt: "Commission Club booked meetings calendar", width: 1200, height: 1040 },
  ],
};

const DIAMOND: CaseStudy = {
  logoSrc: "/vsl/testimonials/diamond-logo.png",
  ...
  screenshots: [
    { src: "/vsl/testimonials/diamond-1.png", alt: "Diamond Trading transactions table", width: 1200, height: 620 },
    { src: "/vsl/testimonials/diamond-2.jpeg", alt: "Diamond Trading November to December calendar", width: 1200, height: 900 },
    { src: "/vsl/testimonials/diamond-3.jpeg", alt: "Diamond Trading December calendar", width: 1200, height: 900 },
  ],
};
