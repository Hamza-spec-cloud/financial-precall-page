...
const LOGOS: { src: string; alt: string; width: number; height: number; maxHeight?: number }[] = [
  ...
  { src: "/testimonials/galriv-logo.png",  alt: "Galriv Capital",              width: 480, height: 272, maxHeight: 96 },
  { src: "/marquee/diamond-institute.png", alt: "Diamond Trading Institution", width: 480, height: 272 },
  { src: "/marquee/byeb.png",              alt: "BYEB",                        width: 480, height: 272 },
  { src: "/marquee/commission-club.png",   alt: "Commission Club",             width: 480, height: 272 },
];
